...
export default function TicketShow(): React.JSX.Element {
  ...
  const handleMetaChange = async (updates: { status?: TicketStatus; priority?: TicketPriority; assignee_id?: number | null }): Promise<void> => {
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-64 border-l border-white/10 overflow-y-auto">
          <TicketMetaPanel ticket={ticket} onChange={handleMetaChange} />
        </aside>
      </div>
    </div>
  );
